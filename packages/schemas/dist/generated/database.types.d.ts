...
export type NotificationType = 'registration_confirmed' | 'event_reminder' | 'event_cancelled' | 'event_approved' | 'event_rejected' | 'new_registration' | 'payment_received' | 'message_received' | 'system_announcement';
export type AuditAction = 'event_approved' | 'event_rejected' | 'event_featured' | 'event_unfeatured' | 'organizer_verified' | 'organizer_rejected' | 'user_role_changed' | 'user_deactivated' | 'user_activated' | 'registration_created' | 'payment_completed' | 'system_config_changed';
