...
function buildUserPrompt(input: TranslateContentInput): string {
...
): Promise<TranslateContentOutput | null> {
  try {
    ...
    const result = JSON.parse(response.content) as TranslateContentOutput;
