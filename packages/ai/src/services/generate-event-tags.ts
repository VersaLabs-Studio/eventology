...
function buildUserPrompt(input: GenerateEventTagsInput): string {
...
): Promise<GenerateEventTagsOutput | null> {
  try {
    ...
    const result = JSON.parse(response.content) as GenerateEventTagsOutput;
