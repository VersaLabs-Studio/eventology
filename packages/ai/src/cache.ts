...
function getSupabase(): SupabaseClient {
  ...
  if (!url || !key) {
    throw new Error(
      '[AI Cache] NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY are required.',
    );
  }
 ...
 */
export function setCacheClient(client: SupabaseClient): void {
  _supabase = client;
}
