 ...
 */
export async function generateEventSummary(input) {
    try {
        ...
        console.warn('[AI] generateEventSummary failed:', err instanceof Error ? err.message : 'Unknown error');
        return null;
    }
}
//# sourceMappingURL=generate-event-summary.js.map