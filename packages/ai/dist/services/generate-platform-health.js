 ...
 */
export async function generatePlatformHealthSummary(input) {
    try {
        ...
        console.warn('[AI] generatePlatformHealthSummary failed:', err instanceof Error ? err.message : 'Unknown error');
        return null;
    }
}
//# sourceMappingURL=generate-platform-health.js.map