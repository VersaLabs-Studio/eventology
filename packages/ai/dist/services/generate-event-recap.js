 ...
 */
export async function generateEventRecap(input) {
    try {
        ...
        console.warn('[AI] generateEventRecap failed:', err instanceof Error ? err.message : 'Unknown error');
        return null;
    }
}
//# sourceMappingURL=generate-event-recap.js.map