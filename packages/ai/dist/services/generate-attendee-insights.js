 ...
 */
export async function generateAttendeeInsights(input) {
    try {
        ...
        console.warn('[AI] generateAttendeeInsights failed:', err instanceof Error ? err.message : 'Unknown error');
        return null;
    }
}
//# sourceMappingURL=generate-attendee-insights.js.map