 ...
 */
export async function generatePerformancePrediction(input) {
    try {
        ...
        console.warn('[AI] generatePerformancePrediction failed:', err instanceof Error ? err.message : 'Unknown error');
        return null;
    }
}
//# sourceMappingURL=generate-performance-prediction.js.map