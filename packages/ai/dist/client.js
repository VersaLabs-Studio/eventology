...
export async function callAI(options) {
    ...
    if (!apiKey) {
        throw new Error('[AI] OPENROUTER_API_KEY is not set. Add it to your environment variables.');
    }
    ...
    throw new Error(`[AI] All models in the ${options.modelTier} tier chain exhausted.\n` +
