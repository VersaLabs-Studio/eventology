    ...
    <footer className="bg-foreground text-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            ...
            <p className="mt-4 text-sm text-white/60 max-w-xs">
              The modern event management platform for Addis Ababa. Discover, attend, and organize events.
            </p>
          </div>
          <div>
            <h4 className="font-display font-semibold text-sm mb-4">Discover</h4>
          ...
          <div>
            <h4 className="font-display font-semibold text-sm mb-4">For Organizers</h4>
            <ul className="space-y-3">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-white/40">Made in Addis Ababa 🇪🇹</p>
        </div>
      </div>
    </footer>
  );
