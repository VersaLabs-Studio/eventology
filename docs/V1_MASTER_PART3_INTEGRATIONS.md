...
1. [Payment Integration — Chapa](#1-payment-integration--chapa)
2. [SMS Integration — Africa's Talking](#2-sms-integration--africas-talking)
3. [Email Integration — Resend](#3-email-integration--resend)
4. [Push Notifications — Expo Push](#4-push-notifications--expo-push)
5. [AI Integration — OpenRouter](#5-ai-integration--openrouter)
6. [Internationalization (i18n)](#6-internationalization-i18n)
7. [Calendar Integration](#7-calendar-integration)
8. [Maps & Geolocation](#8-maps--geolocation)
9. [Authentication — better-auth](#9-authentication--better-auth)
10. [File Storage — Supabase Storage](#10-file-storage--supabase-storage)
...
| 11 | `translateContent` | Translate EN↔AM accurately | Light | 7d |
...
> **Next Document:** [V1_MASTER_PART4_TIMELINE.md](./V1_MASTER_PART4_TIMELINE.md) — Week-by-week execution plan with daily task breakdown, milestones, and verification checkpoints.
