 ...
 * Uses cookie-based auth for seamless session sharing with the browser client.
 */
 ...
 * Use ONLY in API routes that need elevated access (e.g., webhooks, admin operations).
